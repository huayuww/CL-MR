...
def run_videos(folder_dir: str, model, save_dir: str = None):
    ...
    for video_name in video_list:
        ...
        save_txt_name = f'{os.path.splitext(video_name)[0]}-botsort-high-conf-{frame_height}-{frame_width}.txt'
...
def main():
    ...
    save_dir = '/work/andyee1997/huayu/vocal/tracking/output/botsort_results'
